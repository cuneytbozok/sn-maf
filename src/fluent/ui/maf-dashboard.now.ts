...
/**
 * Platform dashboard shell (instance-aligned). Chart/list widgets use linked sys_report records.
 */
export const mafDashboardOverview = Dashboard({
    $id: Now.ID['df7daadf6f5c426aa548a142e0ecd603'],
    name: 'Maturity Assessment Overview',
    active: true,
    tabs: [
        {
            $id: Now.ID['4569195dfafa43baa5447d65722ed706'],
            name: 'Summary',
            widgets: [
                {
                    $id: Now.ID['f3b3b0a98a9e4922bb641c9c3e44f8a0'],
                    component: 'rich-text',
                    componentProps: {
        ...
        {
            $id: Now.ID['edcbee772df74d42ab4ef1caad650ff5'],
            name: 'Details',
            widgets: [
                {
                    $id: Now.ID['eca313466f9c476c83d466cf887b6c38'],
                    component: 'rich-text',
                    componentProps: {
        ...
        {
            $id: Now.ID['4d3c5b13095145e5b7ecd15163b422b2'],
            name: 'AI Summary',
            widgets: [
                {
                    $id: Now.ID['383c67d6f0c644d8899de6d7aa4ed25a'],
                    component: 'rich-text',
                    componentProps: {
