...
Record({
  ...
  data: {
    ...
    threshold_amber: 80,
    higher_is_better: true,
    weight_in_category: 0.05714285714285714,
    unit: '%',
    active: true,
  },
})
...
Record({
  ...
  data: {
    ...
    threshold_amber: 50,
    higher_is_better: true,
    weight_in_category: 0.02857142857142857,
    unit: '%',
    active: true,
  },
})
...
Record({
  ...
  data: {
    ...
    threshold_amber: 80,
    higher_is_better: true,
    weight_in_category: 0.047619047619047616,
    unit: '%',
    active: true,
  },
})
...
Record({
  ...
  data: {
    ...
    threshold_amber: 80,
    higher_is_better: true,
    weight_in_category: 0.07619047619047618,
    unit: '%',
    active: true,
  },
})
...
Record({
  ...
  data: {
    ...
    threshold_amber: 50,
    higher_is_better: true,
    weight_in_category: 0.03809523809523809,
    unit: '%',
    active: true,
  },
})
...
Record({
  ...
  data: {
    ...
    threshold_amber: 30,
    higher_is_better: true,
    weight_in_category: 0.019047619047619046,
    unit: '%',
    active: true,
  },
})
